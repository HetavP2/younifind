            ...
            <div className="mx-auto max-w-7xl bg-transparent overflow-y-scroll h-[550px] no-scrollbar sm:px-6 lg:px-8">
              ...
              {stopLoading && (
                <motion.button
                  ...
                  onHoverStart={(e) => {}}
                  onHoverEnd={(e) => {}}
                  className="inline-flex items-center justify-center px-4 py-3 mt-4 text-base font-medium text-center text-white rounded-lg bg-royalblue hover:bg-blue-800 focus:ring-4 focus:ring-blue-900"
                >
