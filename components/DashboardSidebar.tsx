...
const showMenu1 = (flag) => {
  if (flag) {
    icon1.classNameList.toggle("rotate-180");
    menu1.classNameList.toggle("hidden");
  }
};
...
const showMenu2 = (flag) => {
  if (flag) {
    icon2.classNameList.toggle("rotate-180");
  }
};
...
const showMenu3 = (flag) => {
  if (flag) {
    icon3.classNameList.toggle("rotate-180");
  }
};
...
const showNav = (flag) => {
  if (flag) {
    Main.classNameList.toggle("-translate-x-full");
    Main.classNameList.toggle("translate-x-0");
    open.classNameList.toggle("hidden");
    close.classNameList.toggle("hidden");
  }
};
</script> */}
    </>
